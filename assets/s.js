(function (w, d) {
  ...
  !(function (e, r, t, n, a, d) {
    ...
    function i(e, t, n, a) {
      return (
        (t && r.getElementById(t)) ||
          ((a = r.createElement(e || "SCRIPT")),
          t && (a.id = t),
          n && (a.onload = n),
  ...
  (zaraz.pageVariables = {}),
    (zaraz.track = function (a, e, t) {
      ...
      Object.keys(localStorage)
        ...
        .forEach((a) => (r.data[a.slice(7)] = localStorage.getItem(a))),
        Object.keys(sessionStorage)
          .filter((a) => a.startsWith("_zaraz_"))
          .forEach((a) => (r.data[a.slice(7)] = sessionStorage.getItem(a))),
        Object.keys(zaraz.pageVariables).forEach(
          (a) => (r.data[a] = zaraz.pageVariables[a])
        ),
        ...
        fetch("https://preview.colorlib.com/cdn-cgi/zaraz/t", {
          ...
          .catch(
            () => (
              console.warn(
                "Large event payload sent to Cloudflare Zaraz, cannot assure deliverability."
              ),
              fetch("https://preview.colorlib.com/cdn-cgi/zaraz/t", {
                credentials: "include",
                method: "POST",
    ...
    (zaraz.set = function (a, e, t) {
      (prefixedKey = "_zaraz_" + a),
        t && "session" == t.scope
          ? w.sessionStorage.setItem(prefixedKey, e)
          : t && "page" == t.scope
          ? (zaraz.pageVariables[a] = e)
          : w.localStorage.setItem(prefixedKey, e),
        (zaraz.__watchVar = { key: a, value: e });
    });
  /* for (const a of zarazData.tracks) zaraz.track(a); */
  for (; zaraz._preSet.length; ) {
    const [a, e, t] = zaraz._preSet.pop();
    zaraz.set(a, e, t), delete zarazData["z_" + a];
  }
  delete zarazData.tracks, delete zarazData._preSet;
  zaraz.fulfilTrigger = function (a, r, z, g) {
    zaraz.__zarazTriggerMap || (zaraz.__zarazTriggerMap = {}),
      ...
      zaraz.track(
        "__zarazEmpty",
        { ...z, __zarazClientTriggers: zaraz.__zarazTriggerMap[a] },
        g
      );
  };
  (window.dataLayer = w.dataLayer || []),
    (zaraz._processDataLayer = (a) => {
      if (a.event) {
        let e = {};
        for (obj of dataLayer.slice(0, dataLayer.indexOf(a) + 1))
          e = { ...e, ...obj };
    ...
    Object.defineProperty(w.dataLayer, "push", {
      ...
      value: function (...a) {
        ...
        return zaraz._processDataLayer(a[0]), e;
      },
    }),
